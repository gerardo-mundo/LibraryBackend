        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeKey = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ISSN = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: true),
                    Year = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    AuthorOne = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    AuthorTwo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    AuthorThree = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Assessor = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Year = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnrollmentNum = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: true),
                    EmployeeKey = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
